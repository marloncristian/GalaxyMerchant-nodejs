...
var compiler = require("./analyzer.js");
var processor = require("./processor.js");

/**
 * contexto global de valores
 */
...
/**
 * @param question pergunta a ser respondida
 */
module.exports.translate = function (expression) {
    var decompiled = compiler.decompile(expression);
    return processor.process(module.exports.context, decompiled);
};
